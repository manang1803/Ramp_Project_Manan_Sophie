...
def get_estimator():
    ...
    numerical_cols = numeric_cols = ['t','rr3', 'ff','vv','hbas','rafper','paris_covid','pm10','parks_change', 'residential_change', 'grocery_change', 'workplace_change','stations_change','retail_change','flow_traffic','traffic_occupation','stringency_index','vehicle_number']
    ...
    pipe = make_pipeline(FunctionTransformer(_merge_external_data, validate=False),date_encoder, preprocessor,
             ...
             colsample_bynode=1, colsample_bytree=0.8790730386941, gamma=0.11903774537530729, gpu_id=-1,
             ...
             reg_alpha=5.3603597158578445, reg_lambda=1.3954299611600072, scale_pos_weight=1,
             subsample=0.6186297135971556, tree_method='exact', validate_parameters=1,
             verbosity=None))
